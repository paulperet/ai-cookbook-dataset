...
```
    ...
    [ImagesResponse(created=1701994117, data=[Image(b64_json=None, revised_prompt=None, url='...')])]
...
```
    ...
    [ImagesResponse(created=1701994139, data=[Image(...), Image(...)])]
...
```
    ...
    [ImagesResponse(created=1701994167, data=[Image(...)])]
