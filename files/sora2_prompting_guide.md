...
| :--: | :--: |
| <p><small>[Download this image](https://cdn.openai.com/API/docs/images/sora/woman_skyline_original_720p.jpeg)</small></p> | <p><small>Prompt: _“She turns around and smiles, then slowly walks out of the frame.”_</small></p> |
| <p><small>[Download this image](https://cdn.openai.com/API/docs/images/sora/monster_original_720p.jpeg)</small></p> | <p><small>Prompt: _“The fridge door opens. A cute, chubby purple monster comes out of it.”_</small></p> |
...
| --- | --- |
| <p><small>Original Video</small></p> | <p><small>_Prompt: “Change the color of the monster to orange”_</small></p> |
| <p><small>Original Video</small></p> | <p><small>_Prompt: “A second monster comes out right after”_</small></p> |
...
### Example 1
```text
Style: Hand-painted 2D/3D hybrid animation with soft brush textures, warm tungsten lighting, and a tactile, stop-motion feel. The aesthetic evokes mid-2000s storybook animation — cozy, imperfect, full of mechanical charm. Subtle watercolor wash and painterly textures; warm–cool balance in grade; film