...
[Collecting faiss-cpu==1.7.4, ..., Successfully installed faiss-cpu-1.7.4]
...
[Requirement already satisfied: langchain in /usr/local/lib/python3.10/dist-packages (0.2.9), ..., Successfully installed mistralai-0.4.2]
...
[Requirement already satisfied: llama-index==0.10.55 in /usr/local/lib/python3.10/dist-packages (0.10.55), ..., Successfully installed mistralai-0.4.2]
...
[Collecting mistral-haystack==0.0.1, ..., Successfully installed backoff-2.2.1 haystack-ai-2.3.0 haystack-experimental-0.1.0 lazy-imports-0.3.1 mistral-haystack-0.0.1 monotonic-1.6 posthog-3.5.0]
