# Building Secure Agentic AI Systems with Gemini and Safety Guardrails

## A Guide to Defending Against Jailbreaks using Google ADK with LLM-as-a-Judge and Model Armor

In this guide, you'll learn how to build **production-ready Agentic AI systems** with comprehensive **safety guardrails** using Google's Agent Development Kit (ADK), Gemini, and Cloud services.
...
Before you build safe agents, it's important to understand what you're protecting against.
...
First, create a calculator tool with a hidden vulnerability for demonstration:
...
### Step 2: Create an Unsafe Agent

Now, create an agent without any safety guardrails:
...
### Step 3: Create a Helper Function for Agent Conversations

To interact with your agent, create a helper function:
...
### Step 4: Test the Unsafe Agent

Now, test your unsafe agent with normal usage:
...
**Discussion Point:** What vulnerabilities do you see in the agent above?
...
### Step 1: Create Your Safety Judge Agent

First, create the safety judge agent with specialized instructions:
...
### Step 2: Test the Safety Judge

Now, test your judge with safe and unsafe examples:
...
### Step 3: Implement the LLM-as-a-Judge Plugin

Now let's create the actual plugin that uses your judge. First, import the necessary modules:
...
Then, implement the safety plugin:
...
This guide has covered the setup, threat analysis, and implementation of the LLM-as-a-Judge safety approach. In the next section, you'll learn about the Model Armor approach and how to combine both methods for maximum security.