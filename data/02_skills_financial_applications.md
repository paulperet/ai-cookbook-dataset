...
3. [Use Case 1: Financial Dashboard Creation](#financial-dashboard)
    1. [Excel Financial Model](#excel-model)
    2. [Executive PowerPoint](#executive-ppt)
4. [Use Case 2: Portfolio Analysis Workflow](#portfolio-analysis)
    1. [Portfolio Analytics Excel](#portfolio-excel)

## Prerequisites

This guide assumes you've completed the foundational introduction to Claude Skills.

If you haven't:
1. Complete the initial setup from the introductory notebook.
2. Verify your environment with the test cells.
3. Ensure you can create and download files.

**Required:**
- Anthropic API key configured
- SDK version 0.69.0 or later installed from the whl file
- Virtual environment activated

## 1. Setup & Data Loading

Let's start by importing our dependencies and loading the financial data we'll work with throughout this tutorial.
...
### 1.2 Load Financial Data

We have four datasets representing different aspects of a company's financial position. Let's load them.

**Load Financial Statements CSV:**
...
Now, let's define helper functions to streamline our workflow with the Skills API.
...
First, extract the key financial metrics from our loaded data to structure the prompt.
...
Now, use the helper function to call the Claude API with the XLSX skill.
...
**Step 1: Calculate Key Metrics and Prepare the Prompt**

First, calculate the necessary metrics to populate the presentation.
...
**Step 2: Generate the PowerPoint Presentation**

Now, call the API with the PPTX skill to create the presentation.
...
We'll start by creating an Excel workbook with portfolio analytics, which will serve as the foundation for our investment recommendations.

### 3.1 Portfolio Analytics Excel

Before we create the investment committee presentation, we need to analyze our portfolio data in detail.

**Step 1: Prepare Portfolio Data and Prompt**

Extract the top holdings and sector allocation data to structure a detailed prompt for the Excel file.
