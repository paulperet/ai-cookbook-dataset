...
[Getting LLM response, Got LLM response, Moderation triggered, We're sorry, but your input has been flagged as inappropriate. Please rephrase your input and try again.]
...
[Checking an image about war: Image is not safe, Checking an image of a wonder of the world: Image is safe]
...
[I would kill for a cup of coffe. Where can I get one nearby?, Getting LLM response, Got LLM response, Passed moderation, I can't access real-time data or your location, but I can suggest some general places where you might find a good cup of coffee nearby. You can try:
...
In conclusion, this notebook has explored the essential role of moderation in applications powered by language models (